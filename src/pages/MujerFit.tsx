...
const MujerFit = () => (
  <div className="min-h-screen bg-background font-body">
    <SEO
      title="Programa Mujer Fit | Entrena con Estructura"
      description="Gana fuerza, mejora tu salud y crea hábitos sostenibles con el programa online Mujer Fit de VitalFem. Entrenamiento personalizado sin rutinas genéricas."
      url="https://www.vitalfem.es/mujer-fit"
    />
    <Navbar />
